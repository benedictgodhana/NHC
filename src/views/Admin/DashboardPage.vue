<template>
  <v-app>
    ...
    <v-row>
        ...
        <v-col cols="12" sm="6" md="3">
            <v-card class="pa-4 elevation-2" outlined style="width: 100%; border: 1px solid #ddd;">
                <v-icon color="amber" size="40">mdi-currency-usd</v-icon>
                <div class="text-title mt-2">Monthly Revenue</div>
                <div class="text-subtitle-1 font-weight-bold">{{ monthlyTransactions  }}</div>
                <v-btn class="mt-3" color="amber" block>View Details</v-btn>
            </v-card>
        </v-col>
        ...
        <v-col cols="12" sm="6" md="3">
            <v-card class="pa-4 elevation-2" outlined style="width: 100%; border: 1px solid #ddd;">
                <v-icon color="indigo" size="40">mdi-currency-usd</v-icon>
                <div class="text-title mt-2">Today Revenue</div>
                <div class="text-subtitle-1 font-weight-bold">{{  todaysTransactions }}</div>
